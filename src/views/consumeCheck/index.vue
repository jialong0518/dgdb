    ...
    <el-row :gutter="20" style="padding: 20px;">
        <el-card class="box-card" style="width: 100%">
            <div slot="header" class="clearfix">
                ...
                <el-input style="width: 100px;margin-right:20px;" @input="reduceBalanceFun" v-model="reduceBalance" placeholder="" autocomplete="off"></el-input>
                <span>余额抵扣：</span>
                <el-input style="width: 100px;margin-right:20px;" @input="deductionFun" v-model="buckleBalance" placeholder="" autocomplete="off"></el-input>
                <span>其他优惠抵扣：</span>
                <el-input style="width: 100px;margin-right:20px;" @input="deductionOtherFun" v-model="buckleOtherBalance" placeholder="" autocomplete="off"></el-input>
      ...
      if(this.customerPhone.length !== 0){
          if(this.buckleBalance !== ''){
              ...
              this.shouldBalance = this.buyPrice;
                //   会员余额：{{customerBalance}}shouldBalance buyPrice
                //   其他优惠：{{customerOtherBalance}}
                //     余额抵扣：{{buckleBalance}}
                //     其他优惠抵扣：{{buckleOtherBalance}}
                //    会员结余：{{newBalance}}
                //   其他优惠余额：{{newOtherBalance}}
                //   优惠：{{reduceBalance}} shouldBalance  buyPrice
            //   if(Number(this.customerBalance) - Number(buyPrice) > 0){
            //       this.newBalance = (Number(this.customerBalance) - Number(buyPrice)).toFixed(2);
            //       this.buckleBalance = Number(buyPrice)
            //       this.shouldBalance = 0
            //       console.log('1')
            //   }else{
            //       this.newBalance = 0
            //       this.buckleBalance = Number(this.customerBalance)
            //        this.shouldBalance = Math.abs((Number(this.customerBalance) - Number(buyPrice)).toFixed(2))
            //        console.log('2')
            //   }
            //   this.buckleBalance = this.customerBalance;
            //   this.newBalance = (Number(this.customerBalance) - Number(buckleBalance)).toFixed(2);
            //   let yue = (Number(buyPrice) - Number(this.buckleBalance)).toFixed(2);
            //   this.shouldBalance = yue
          }
